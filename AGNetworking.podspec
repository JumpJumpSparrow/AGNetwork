#
#  Be sure to run `pod spec lint AGNetworking.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "convinence to use and easy to buil net request"
  ...
  # Or just: s.author    = "cunfa"
  # s.authors            = { "cunfa" => "cunfamiao@163.com" }
  # s.social_media_url   = "http://twitter.com/cunfa"
